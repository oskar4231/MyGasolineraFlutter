  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // Custom Header matching Ajustes/Facturas
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Card(
                      color: isDark ? const Color(0xFF3E3E42) : theme.cardColor,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            // Título
                            _buildInfoRow(
                                context, l10n.titulo, factura['titulo']),
                            ...
                            if (factura['descripcion'] != null &&
                              ...
                              _buildInfoRow(context, l10n.descripcion,
                                  factura['descripcion']),
                          ],
                        ),
                      ),
